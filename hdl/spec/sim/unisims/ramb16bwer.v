...
// \   \  /  \    Timestamp : Wed Mar 22 16:11:55 PST 2006
//  \___\/\___\
//
// Revision:
//    03/22/06 - Initial version.
//    08/23/06 - fixed CR 422403.
//    10/13/06 - fixed CR 426962
...
module RAMB16BWER (DOA, DOB, DOPA, DOPB, 
    ...
    reg [31:0] doa_out, doa_outreg, doa_out_mux;
    reg [31:0] doa_out_buf, dob_out_buf;
    reg [31:0] dob_out, dob_outreg, dob_out_mux;
    reg [3:0]  dopa_out_buf, dopb_out_buf;
    reg [3:0] dopa_out, dopa_outreg, dopa_out_mux;
    reg [3:0] dopb_out, dopb_outreg, dopb_out_mux;
    reg [8:0] count;
    reg notifier, notifier_a, notifier_b;
    reg rsta_reg, rstb_reg;
    reg rsta_reg_col, rstb_reg_col;

    reg rst_async_flag = 0;
    wire async_rsta_in, async_rstb_in;
    ...
    wire clka_in, ena_in, rsta_in;
    wire clkb_in, enb_in, rstb_in;
    ...
    buf b_doa0_out (doa_out0, doa_out_mux[0]);
    buf b_doa1_out (doa_out1, doa_out_mux[1]);
    buf b_doa10_out (doa_out10, doa_out_mux[10]);
    buf b_doa11_out (doa_out11, doa_out_mux[11]);
    buf b_doa12_out (doa_out12, doa_out_mux[12]);
    buf b_doa13_out (doa_out13, doa_out_mux[13]);
    buf b_doa14_out (doa_out14, doa_out_mux[14]);
    buf b_doa15_out (doa_out15, doa_out_mux[15]);
    buf b_doa16_out (doa_out16, doa_out_mux[16]);
    buf b_doa17_out (doa_out17, doa_out_mux[17]);
    buf b_doa18_out (doa_out18, doa_out_mux[18]);
    buf b_doa19_out (doa_out19, doa_out_mux[19]);
    buf b_doa2_out (doa_out2, doa_out_mux[2]);
    buf b_doa20_out (doa_out20, doa_out_mux[20]);
    buf b_doa21_out (doa_out21, doa_out_mux[21]);
    buf b_doa22_out (doa_out22, doa_out_mux[22]);
    buf b_doa23_out (doa_out23, doa_out_mux[23]);
    buf b_doa24_out (doa_out24, doa_out_mux[24]);
    buf b_doa25_out (doa_out25, doa_out_mux[25]);
    buf b_doa26_out (doa_out26, doa_out_mux[26]);
    buf b_doa27_out (doa_out27, doa_out_mux[27]);
    buf b_doa28_out (doa_out28, doa_out_mux[28]);
    buf b_doa29_out (doa_out29, doa_out_mux[29]);
    buf b_doa3_out (doa_out3, doa_out_mux[3]);
    buf b_doa30_out (doa_out30, doa_out_mux[30]);
    buf b_doa31_out (doa_out31, doa_out_mux[31]);
    buf b_doa4_out (doa_out4, doa_out_mux[4]);
    buf b_doa5_out (doa_out5, doa_out_mux[5]);
    buf b_doa6_out (doa_out6, doa_out_mux[6]);
    buf b_doa7_out (doa_out7, doa_out_mux[7]);
    buf b_doa8_out (doa_out8, doa_out_mux[8]);
    buf b_doa9_out (doa_out9, doa_out_mux[9]);

    buf b_dopa0 (DOPA[0], dopa_out0);
    buf b_dopa1 (DOPA[1], dopa_out1);
    buf b_dopa2 (DOPA[2], dopa_out2);
    buf b_dopa3 (DOPA[3], dopa_out3);
    buf b_dopa0_out (dopa_out0, dopa_out_mux[0]);
    buf b_dopa1_out (dopa_out1, dopa_out_mux[1]);
    buf b_dopa2_out (dopa_out2, dopa_out_mux[2]);
    buf b_dopa3_out (dopa_out3, dopa_out_mux[3]);
    ...
    buf b_dob0_out (dob_out0, dob_out_mux[0]);
    buf b_dob1_out (dob_out1, dob_out_mux[1]);
    buf b_dob10_out (dob_out10, dob_out_mux[10]);
    buf b_dob11_out (dob_out11, dob_out_mux[11]);
    buf b_dob12_out (dob_out12, dob_out_mux[12]);
    buf b_dob13_out (dob_out13, dob_out_mux[13]);
    buf b_dob14_out (dob_out14, dob_out_mux[14]);
    buf b_dob15_out (dob_out15, dob_out_mux[15]);
    buf b_dob16_out (dob_out16, dob_out_mux[16]);
    buf b_dob17_out (dob_out17, dob_out_mux[17]);
    buf b_dob18_out (dob_out18, dob_out_mux[18]);
    buf b_dob19_out (dob_out19, dob_out_mux[19]);
    buf b_dob2_out (dob_out2, dob_out_mux[2]);
    buf b_dob20_out (dob_out20, dob_out_mux[20]);
    buf b_dob21_out (dob_out21, dob_out_mux[21]);
    buf b_dob22_out (dob_out22, dob_out_mux[22]);
    buf b_dob23_out (dob_out23, dob_out_mux[23]);
    buf b_dob24_out (dob_out24, dob_out_mux[24]);
    buf b_dob25_out (dob_out25, dob_out_mux[25]);
    buf b_dob26_out (dob_out26, dob_out_mux[26]);
    buf b_dob27_out (dob_out27, dob_out_mux[27]);
    buf b_dob28_out (dob_out28, dob_out_mux[28]);
    buf b_dob29_out (dob_out29, dob_out_mux[29]);
    buf b_dob3_out (dob_out3, dob_out_mux[3]);
    buf b_dob30_out (dob_out30, dob_out_mux[30]);
    buf b_dob31_out (dob_out31, dob_out_mux[31]);
    buf b_dob4_out (dob_out4, dob_out_mux[4]);
    buf b_dob5_out (dob_out5, dob_out_mux[5]);
    buf b_dob6_out (dob_out6, dob_out_mux[6]);
    buf b_dob7_out (dob_out7, dob_out_mux[7]);
    buf b_dob8_out (dob_out8, dob_out_mux[8]);
    buf b_dob9_out (dob_out9, dob_out_mux[9]);

    buf b_dopb0 (DOPB[0], dopb_out0);
    buf b_dopb1 (DOPB[1], dopb_out1);
    buf b_dopb2 (DOPB[2], dopb_out2);
    buf b_dopb3 (DOPB[3], dopb_out3);
    buf b_dopb0_out (dopb_out0, dopb_out_mux[0]);
    buf b_dopb1_out (dopb_out1, dopb_out_mux[1]);
    buf b_dopb2_out (dopb_out2, dopb_out_mux[2]);
    buf b_dopb3_out (dopb_out3, dopb_out_mux[3]);
    ...
    initial begin
        ...
        if ((DATA_WIDTH_A == 0) && (DATA_WIDTH_B == 0)) begin
            $display("Attribute Syntax Error : Both attributes DATA_WIDTH_A and DATA_WIDTH_B on RAMB16BWER instance %m can not be 0.");
            $finish;
        end
	...
	if ((SIM_COLLISION_CHECK != "ALL") && (SIM_COLLISION_CHECK != "NONE") && (SIM_COLLISION_CHECK != "WARNING_ONLY") && (SIM_COLLISION_CHECK != "GENERATE_X_ONLY")) begin
        ...
        case (DOA_REG)
           0,1 : ;
           default : begin
                          $display("Attribute Syntax Error : The attribute DOA_REG on RAMB16BWER instance %m is set to %d. Legal values for this attribute are 0 or 1.", DOA_REG);
                          $finish;
                      end
        endcase
        ...
        case (DOB_REG)
           0,1 : ;
           default : begin
                          $display("Attribute Syntax Error : The attribute DOB_REG on RAMB16BWER instance %m is set to %d. Legal values for this attribute are 0 or 1.", DOB_REG);
                          $finish;
                      end
        endcase
        ...
        case (RSTTYPE)
          ...
          default : begin
                          $display("Attribute Syntax Error : The attribute RSTTYPE on RAMB16BWER instance %m is set to %s.  Legal values for this attribute are SYNC or ASYNC.", RSTTYPE);
                          $finish;
                      end
...
// ***** Port A *****
//CR 422403
    assign async_rsta_in = ((ena_in == 1) && (rst_async_flag == 1) && (rsta_in == 1'b1)) ? 1 : 0;

    always @(posedge clka_in or posedge gsr_in or posedge async_rsta_in) begin

	if ((gsr_in == 1) || (async_rsta_in == 1))begin
          if(gsr_in == 1) begin
	    ...
	    else if (rsta_in == 0 && wr_mode_a == 2'b00) begin
	    ...
	    end // if (rsta_in == 0 && wr_mode_a == 2'b00)
	    
	    else if (rsta_in == 0 && wr_mode_a == 2'b01) begin
	    ...
	    else if (rsta_in == 0 && wr_mode_a == 2'b10) begin
	    ...
	    end // if (rsta_in == 0 && wr_mode_a == 2'b10)
...
//CR 422403
    ...
    assign async_rstb_in = ((enb_in == 1) && (rst_async_flag == 1) && (rstb_in == 1'b1)) ? 1 : 0;

    always @(posedge clkb_in or posedge gsr_in or posedge async_rstb_in) begin

	if ((gsr_in == 1) || (async_rstb_in == 1)) begin
          if(gsr_in == 1) begin
	    ...
	    else if (rstb_in == 0 && wr_mode_b == 2'b00) begin
	    ...
	    end // if (rstb_in == 0 && wr_mode_b == 2'b00)
	    
	    else if (rstb_in == 0 && wr_mode_b == 2'b01) begin
	    ...
	    else if (rstb_in == 0 && wr_mode_b == 2'b10) begin
	    ...
	    end // if (rstb_in == 0 && wr_mode_b == 2'b10)
...
// Fixed 422403, 430517 changed rsta_in to async_rsta_in
   always @(posedge clka_in or posedge gsr_in or posedge async_rsta_in) begin
...
// 426962
//            else if ((gsr_in == 1'b0) && (rsta_in == 1'b1) && (ena_in == 1'b1)) begin
            else if (gsr_in == 1'b0)  begin
// 427370
                   if ((rsta_in == 1'b1) && (ena_in == 1'b1)) begin
...
// 426962
//                else if ((gsr_in == 1'b0) && (rsta_in == 1'b0) && (ena_in == 1'b1) && (regcea_in == 1'b1)) begin
// 430517
//                else if ((gsr_in == 1'b0) && (rsta_in == 1'b0) && (regcea_in == 1'b1)) begin
                else if ((gsr_in == 1'b0) && (regcea_in == 1'b1)) begin
                    doa_outreg <= doa_out;
                    dopa_outreg <= dopa_out;
                end
            end // if  (gsr_in == 1'b0)
        end // if (DOA_REG == 1)
     end // if (rst_async_flag)
   end // always @ (posedge clka_in or posedge gsr_in)
...
// 426962
//                else if ((gsr_in == 1'b0) && (rsta_in == 1'b0) && (ena_in == 1'b1) && (regcea_in == 1'b1)) begin
                else if ((gsr_in == 1'b0) && (rsta_reg == 1'b0) && (regcea_in == 1'b1)) begin
                    doa_outreg <= doa_out;
                    dopa_outreg <= dopa_out;
                end  
            end // if  (gsr_in == 1'b0)
   ...
   always @(doa_out or dopa_out or doa_outreg or dopa_outreg) begin
        case (DOA_REG)
            ...
            1 : begin
                    doa_out_mux <= doa_outreg;
                    dopa_out_mux <= dopa_outreg;
                end
            default : ;
        endcase
...
// 426962
//            else if ((gsr_in == 1'b0) && (rstb_in == 1'b1) && (enb_in == 1'b1)) begin
            else if (gsr_in == 1'b0)  begin
// 427370
                   if ((rstb_in == 1'b1) && (enb_in == 1'b1)) begin
...
// 426962
//                else if ((gsr_in == 1'b0) && (rstb_in == 1'b0) && (enb_in == 1'b1) && (regceb_in == 1'b1)) begin
// 430517
//                else if ((gsr_in == 1'b0) && (rstb_in == 1'b0) && (regceb_in == 1'b1)) begin
                else if ((gsr_in == 1'b0) && (regceb_in == 1'b1)) begin
                    dob_outreg <= dob_out;
...
// 426962
//                else if ((gsr_in == 1'b0) && (rstb_in == 1'b0) && (enb_in == 1'b1) && (regceb_in == 1'b1)) begin
                else if ((gsr_in == 1'b0) && (rstb_reg == 1'b0) && (regceb_in == 1'b1)) begin
                    dob_outreg <= dob_out;
                    dopb_outreg <= dopb_out;
                end  
            end // if  (gsr_in == 1'b0)
   ...
   always @(dob_out or dopb_out or dob_outreg or dopb_outreg) begin
        case (DOB_REG)
            ...
            1 : begin
                    dob_out_mux <= dob_outreg;
                    dopb_out_mux <= dopb_outreg;
                end
            default : ;
        endcase
...
// need to disable if no checks
	...
	prev_time = curr_time;
	curr_time = $time;
	if (ena_in == 1) rsta_reg_col = rsta_in;
    end
	...
	prev_time = curr_time;
	curr_time = $time;
	if (enb_in == 1) rstb_reg_col = rstb_in;
	...
	begin
		...
		if (col_msg_flag != 3'b000 && ((port === 0 && rstb_reg_col !== 1) || (port === 1 && rsta_reg_col !== 1)))
